...
import com.xunyat.iot.vmp.common.InviteInfo;
import com.xunyat.iot.vmp.common.InviteSessionStatus;
import com.xunyat.iot.vmp.common.InviteSessionType;
import com.xunyat.iot.vmp.common.StreamInfo;
import com.xunyat.iot.vmp.conf.DynamicTask;
import com.xunyat.iot.vmp.conf.UserSetting;
import com.xunyat.iot.vmp.conf.exception.ControllerException;
import com.xunyat.iot.vmp.conf.exception.ServiceException;
import com.xunyat.iot.vmp.conf.exception.SsrcTransactionNotFoundException;
import com.xunyat.iot.vmp.gb28181.bean.*;
import com.xunyat.iot.vmp.gb28181.event.SipSubscribe;
import com.xunyat.iot.vmp.gb28181.session.VideoStreamSessionManager;
import com.xunyat.iot.vmp.gb28181.transmit.cmd.impl.SIPCommander;
import com.xunyat.iot.vmp.gb28181.transmit.cmd.impl.SIPCommanderFroPlatform;
import com.xunyat.iot.vmp.gb28181.utils.SipUtils;
import com.xunyat.iot.vmp.media.zlm.ZLMRESTfulUtils;
import com.xunyat.iot.vmp.media.zlm.ZLMServerFactory;
import com.xunyat.iot.vmp.media.zlm.ZlmHttpHookSubscribe;
import com.xunyat.iot.vmp.media.zlm.dto.hook.HookParam;
import com.xunyat.iot.vmp.media.zlm.dto.hook.OnRecordMp4HookParam;
import com.xunyat.iot.vmp.media.zlm.dto.hook.OnStreamChangedHookParam;
import com.xunyat.iot.vmp.service.*;
import com.xunyat.iot.vmp.service.bean.DownloadFileInfo;
import com.xunyat.iot.vmp.service.bean.ErrorCallback;
import com.xunyat.iot.vmp.service.bean.InviteErrorCode;
import com.xunyat.iot.vmp.service.bean.SSRCInfo;
import com.xunyat.iot.vmp.storager.IRedisCatchStorage;
import com.xunyat.iot.vmp.storager.IVideoManagerStorage;
import com.xunyat.iot.vmp.storager.dao.CloudRecordServiceMapper;
import com.xunyat.iot.vmp.utils.CloudRecordUtils;
import com.xunyat.iot.vmp.utils.DateUtil;
import com.xunyat.iot.vmp.vmanager.bean.ErrorCode;
import com.xunyat.iot.vmp.media.zlm.dto.HookSubscribeFactory;
import com.xunyat.iot.vmp.media.zlm.dto.HookSubscribeForRecordMp4;
import com.xunyat.iot.vmp.media.zlm.dto.HookSubscribeForStreamChange;
