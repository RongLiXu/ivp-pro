package com.xunyat.iot.vmp.gb28181.conf;

import com.xunyat.iot.vmp.gb28181.transmit.event.request.impl.message.notify.cmd.AlarmNotifyMessageHandler;
...
//        properties.setProperty("gov.nist.javax.sip.MESSAGE_PROCESSOR_FACTORY", "gov.nist.javax.sip.stack.NioMessageProcessorFactory");
        ...
        if (sipLog) {
            properties.setProperty("gov.nist.javax.sip.STACK_LOGGER", "conf.gb28181.com.xunyat.iot.vmp.StackLoggerImpl");
            properties.setProperty("gov.nist.javax.sip.SERVER_LOGGER", "conf.gb28181.com.xunyat.iot.vmp.ServerLoggerImpl");
